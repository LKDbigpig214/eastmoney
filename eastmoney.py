...
537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36'}
    ...
    url = 'http://mystock.eastmoney.com/mystock.aspx?f=asz&sc=%s&var=opfavres&rt=1207' % code
...
def isHighThanPre0(code, flag):
    f = {'1': 'sh', '2': 'sz'}
    code = f[flag] + code
    url = 'http://emweb.securities.eastmoney.com/PC_HSF10/FinanceAnalysis/FinanceAnalysisAjax?code=%s&ctype=3'%code
    headers = {'Accept' : 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
               'Accept-Encoding':'gzip, deflate, sdch',
               'Accept-Language':'zh-CN,zh;q=0.8',
               'Cache-Control': 'max-age=0',
